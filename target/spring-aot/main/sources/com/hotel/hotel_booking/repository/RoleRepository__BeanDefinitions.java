...
public class RoleRepository__BeanDefinitions {
  ...
  public static BeanDefinition getRoleRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.hotel.hotel_booking.repository.RoleRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.hotel.hotel_booking.repository.RoleRepositoryImpl__AotRepository(entityManager, context));
      }
    });
